    ...
    <v-card-text class="mt-4">
      ...
      <v-row class="text-center mt-2" style="text-align: center">
        <v-col cols="3" class="px-0">
          <v-chip :color="toleranceValue == 0.1?'primary':''" class="px-md-7 mx-auto" @click="toleranceValue=0.1">0.1%</v-chip>
        </v-col>
        <v-col cols="3" class="px-0">
          <v-chip :color="toleranceValue == 0.5 ?'primary':''" class="px-md-7 mx-auto" @click="toleranceValue=0.5">0.5%</v-chip>
        </v-col>

        <v-col cols="3" class="px-0">
          <v-chip :color="toleranceValue == 1.0 ?'primary':''" class="px-md-7 mx-auto" @click="setToleranceValue(1)">1.0%</v-chip>
        </v-col>
        <v-col cols="3" class="px-0">
