...
<script>
    ...
    export default {
        ...
        mounted: async function(){
          ...
          .then(async res=>{
            console.log(web3Service.currentAddr);
            // if(localStorage.getItem("connectorId") == "injected")
            //   this.SET_CURRENT_ADDR(web3Service.currentAddr);
            console.log("SET_RATE", web3Service.lp_crypto_balance);
        ...
        methods: {
          ...
          connectResult() {
            console.log("curr", web3Service.currentAddr);
            console.log(web3Service.currNetworkID);
